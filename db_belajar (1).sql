...
(1, 'adminganteng@gmail.com', '$2y$10$HBoALwWmtvZDPb3BOcY7m.0aPLNlUvSJ3sS1OUTsrACC2.NWLkHb6', '2023-09-26 14:03:39', NULL, NULL);
...
--
ALTER TABLE `users`
  MODIFY `is_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
